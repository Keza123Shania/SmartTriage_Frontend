...
function buildProfileFromAuth(user: { fullName: string; email: string; role: UserRole; department?: string; hospital?: string }): UserProfile {
              ...
              <div className="flex-1 sm:mb-1">
                ...
                <div className="flex items-center gap-2 mt-1">
                  <p className="text-sm text-white/70 flex items-center gap-1.5 font-medium">
                    ...
                    {displayProfile.role} · {displayProfile.department}
                  </p>
                  {roleMeta && (
