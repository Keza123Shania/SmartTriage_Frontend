...
import {
  Activity, Heart, Wind, Thermometer, Droplet, Search, Zap, Candy,
...
export function ConstantMonitoring() {
  ...
  const patients = useMemo(() => {
    const storeTriaged = storePatients.filter((p) => p.triageStatus === 'TRIAGED');
    return storeTriaged.length > 0 ? (storeTriaged as unknown as MonitoredPatient[]) : MOCK_MONITORED;
  }, [storePatients]);
